...
session_start();
$sid=$_POST["sid"];
$sql = "SELECT DISTINCT * FROM userb,subject,teaches where userb.tid=teaches.tid and teaches.sid=subject.sid and subject.sid='$sid'";
...
<body>
  ...
  <h1><div class="btn-group btn-group-md " role="group" aria-label="...">
    <a href="stusubjects.php" class="btn button_white btn-primary">&nbsp;<span class="glyphicon glyphicon-chevron-left"></span></a>
...
<?php
  ...
  <tr>
	...
	<form action="regteacher.php" method="post">

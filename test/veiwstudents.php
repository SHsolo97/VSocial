...
session_start();
$sql = "select * from usera,vitdetails,primaryinfo where usera.userid=vitdetails.userid and usera.userid=primaryinfo.userid";
...
<?php
  ...
  <tr>
	...
	<form action="../test/stuinfo.php" method="post">
	<input type="hidden" name='uid' value="<?php echo $row["userid"]; ?>"  >
<td><input type="submit"  value="Show Details">   </form> </td>
  </tr>

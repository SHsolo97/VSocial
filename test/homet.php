...
<body>
<center><h3>Welcome <?php 	echo $_SESSION['tname']; ?><h3><br>	<br>
<h3><a href="../test/tsubjects.php">a. Assign Marks in Registered Classes</a></h3><br>
<h3><a href="../test/teasubjects.php">b. Veiw Subjects for Registration</a></h3><br>
...
<div class="col-xs-12 col-md-10"><br><br>
	...
	<div class="col-xs-12 col-md-6 text-center"><h3><a href="../test/tsubjects.php"><img src="../assign.png"><br><br>Assign Marks in Registered Classes</a></h3><br></div>
	<div class="col-xs-12 col-md-6 text-center"><h3><a href="../test/teasubjects.php"><img src="../register.png"><br><br>View Subjects for Registration</a></h3><br></div>
